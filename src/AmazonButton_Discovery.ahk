...
amazon_button_server_file := "AmazonButton_Server.exe"
/*
v2.0
	+ New Version! 
	+ Taking advantange of new naming scheme 
	+ Taking advantage of notification suppress 
0716 0900 
...
while ip_inc < 255
{
	...
	if ip_inc = 254
		...
		msgbox, Click OK then Rapidly Push button and keep it White!
...
if PingError = 0
	...
	IfMsgBox Yes
		DaemonCmd:= amazon_button_server_file . " " . Chosen_IP . " " . DaemonFile . " """ . Button_Comment . """ "
	else
